...
//  through no ncr formula to find element in triangle  this is more optimised 
// import java.util.*;
// public class Arr34 {
// public static long nCr(int n, int r){
// long res=1;
...
// ans = ans * (row - col);
// ans = ans / (col);
// ansRow.add((int)ans);   // int is written to type long into int because we declare ans in long data type 
// }
// return ansRow;
// }
// public static void main(String[] args){
